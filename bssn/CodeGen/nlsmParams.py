...
parameters.add(RequiredParameter.MAXDEPTH, 8)
parameters.add(RequiredParameter.SPLIT_FIX, 256)
...
parameters.add(RequiredParameter.RK_MIN_TOL, 1e-4)
...
amp = parameters.addInitialData("AMP", 1.0)
R = parameters.addInitialData("R", 0.0)
