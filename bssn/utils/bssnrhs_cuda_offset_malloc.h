...
cudaStatus = cudaMemcpy(dev_alphaInt, &alphaInt, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_chiInt, &chiInt, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_KInt, &KInt, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_gt0Int, &gt0Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_gt1Int, &gt1Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_gt2Int, &gt2Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_gt3Int, &gt3Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_gt4Int, &gt4Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_gt5Int, &gt5Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_beta0Int, &beta0Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_beta1Int, &beta1Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_beta2Int, &beta2Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_At0Int, &At0Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_At1Int, &At1Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_At2Int, &At2Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_At3Int, &At3Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_At4Int, &At4Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_At5Int, &At5Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_B0Int, &B0Int, sizeof(int), cudaMemcpyHostToDevice);
...
cudaStatus = cudaMemcpy(dev_B1Int, &B1Int, sizeof(int), cudaMemcpyHostToDevice);
