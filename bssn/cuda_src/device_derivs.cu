...
__global__ void calc_derivs1_unordered(
    double * dev_var_out, double * dev_var_in, double hx, double hy, double hz, 
    const unsigned int host_sz_x, const unsigned int host_sz_y, const unsigned int host_sz_z, 
    int bflag,
    #include "list_of_offset_para.h"
...
__global__ void calc_derivs2_unordered(
    double * dev_var_out, double * dev_var_in, double hx, double hy, double hz, 
    const unsigned int host_sz_x, const unsigned int host_sz_y, const unsigned int host_sz_z, 
    int bflag,
    #include "list_of_offset_para.h"
...
__global__ void calc_derivs12(
    ...
    tid = (blockIdx.x*64 + threadIdx.x) + 1;
...
__global__ void calc_derivs22(
    ...
    tid = (blockIdx.x*64 + threadIdx.x)*2 + 1;
