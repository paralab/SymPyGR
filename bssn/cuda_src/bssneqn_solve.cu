...
int *offset
 ...
 void callculateBSSN_EQ(
    ...
    int *sizeArray
     ...
     int blocks=ceil(*sizeArray*1.0/threadCount);
     int *dev_sizeArray;
     ...
     int loopCount=ceil(blocks*1.0/maximunBlock);

     int i;
     int *offset=0;
     for(i=0;i<loopCount;i++) {
         int blockCount=maximunBlock;
         if(blocks-i*maximunBlock<maximunBlock){
             blockCount=blocks-i*maximunBlock;
         }
         *offset=maximunBlock*i;
         cuda_callculateBSSN <<< blockCount, threadCount >>> (
                 grad_0_alpha,
                         grad_1_alpha,
                         grad_2_alpha,
                         grad_0_beta0,
