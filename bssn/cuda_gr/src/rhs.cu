...
for(unsigned int iter=0;iter<BLK_INTERATIONS;iter++){
		 ...
		 ijk_lm[2*1+0]=max(1,(int)(1 + tile_sz[1]*iter -2*iter2));
		 ijk_lm[2*1+1]=min(ijk_lm[2*1+0]+tile_sz[1],sz[1]-1);

		 ijk_lm[2*2+0]=max(1,(int)(1 + tile_sz[2]*iter -2*iter2));
...
for(unsigned int iter=0;iter<BLK_INTERATIONS;iter++){
		 ...
		 ijk_lm[2*1+0]=max(0,(int)(0 + tile_sz[1]*iter -2*iter3));
		 ijk_lm[2*1+1]=min(ijk_lm[2*1+0]+tile_sz[1],sz[1]);

		 ijk_lm[2*2+0]=max(0,(int)(0 + tile_sz[2]*iter -2*iter3));
