...
int main(int argc, char **argv)
{
    ...
    if(vectorize && !stages)
    {
        #include "./test_loop_vector.cpp"
    }
    else if(!vectorize && !stages)
    {
        #include "./test_loop_novector.cpp"
    }
    else if(vectorize && stages)
    {
        #include "./test_loop_vector_stages.cpp"
    }
    else if(!vectorize && stages)
    {
        #include "./test_loop_novector_stages.cpp"
    }
