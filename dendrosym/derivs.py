...
def generate_boundary_stencil_expr_mixed_deriv_6th(symbol, dim1, dim2, dim1_edge="+", dim2_edge="+", dim1_boundary_away=0, dim2_boundary_away=0, idx_str="pp"):
    ...
    if dim1 == dim2:
        raise Exception("This function should never be called if the dimensions are equal!")
