...
% COLUMN 1 {{{
	...
	\begin{textblock}{14}(0, 10.5)
		...
		\begin{itemize}
			...
			%\parpic[r]{\includegraphics[scale=1.1]{cache_miss_plot.png}}		
		...
		%\begin{wrapfigure}{ht!}{0.5\textwidth}
  		%	\begin{center}
    	%		\includegraphics[scale=1.0]{Staging_Results.png}
  		%	\end{center}
  		%	\caption{Plot comparing the cache size specified and the simularity of }
		%\end{wrapfigure}
		...
		\begin{tikzpicture}
		\begin{axis}[legend style={at={(0.8,-0.35)}},anchor=south,xlabel={max. number of dependancies $\rightarrow$},
		symbolic x coords={20,30,50,80,100,200,300},
		xtick = data,
		ylabel={$\%$ of cache misses $\rightarrow$},grid=major,width=20cm,height=8cm,legend columns=2]
