##################################################################
#
# Script for calculating RHS of CCZ4 formalism. 
# Basic is same as BSSN script with additional variable for ccz4
#
##################################################################
...
a_rhs = l1*dendro.lie(b, a) - 2*a*(K-2*Theta)
...
Theta_rhs = [b[i]*d(i,Theta) for i in dendro.e_i] + (a/2)
...
outs = [a_rhs, b_rhs, gt_rhs, chi_rhs, At_rhs, K_rhs, Gt_rhs, B_rhs, Theta_rhs]
vnames = ['a_rhs', 'b_rhs', 'gt_rhs', 'chi_rhs', 'At_rhs', 'K_rhs', 'Gt_rhs', 'B_rhs', 'Theta_rhs']
