...
cpuMemoryTot = (psutil.virtual_memory().total)/1024/1024
cpuMemoryAvailable = (psutil.virtual_memory().available)/1024/1024
print("---------------------CPU Memory Details ---------------------")
print("Total CPU memory in the system = ", cpuMemoryTot, "MB")
print("Total CPU memory available in the system = ", cpuMemoryAvailable, "MB")

print("---------------------GPU Memory Details ---------------------")
GPUs = GPUtil.showUtilization(True, None, True)

tile_sz = 10
try:
    tile_sz_str = sys.argv[1]
    tile_sz = int(tile_sz_str)
except:
    print("--------------------------------------------------------\n")
    print("You have not specified a tile size. Default is set to 10\n")
...
stencils = {"calc_deriv42_x" : ["", 1, "idx_by_12"],
            "calc_deriv42_y": [2*(tile_sz+6), (tile_sz+6), "idy_by_12"],
            "calc_deriv42_z": [2*(tile_sz+6)*(tile_sz+6), (tile_sz+6)*(tile_sz+6), "idz_by_12"],
            "calc_deriv42_xx": ["", 1, "idx_sqrd_by_12"],
            "calc_deriv42_yy": [2*(tile_sz+6), (tile_sz+6), "idy_sqrd_by_12"],
            "calc_deriv42_zz" : [2*(tile_sz+6)*(tile_sz+6), (tile_sz+6)*(tile_sz+6), "idz_sqrd_by_12"]
            }

# output line setting
outputLine = {"calc_deriv42_x" : "\toutput[pp] = (dev_var_in[loc_pp - 2{}] - 8.0 * dev_var_in[loc_pp - {}] + "
                                 "8.0 * dev_var_in[loc_pp + {}] - dev_var_in[loc_pp + 2{}]) * {};\n",
            "calc_deriv42_y": "\toutput[pp] = (dev_var_in[loc_pp - {}] - 8.0 * dev_var_in[loc_pp - {}] + "
                                 "8.0 * dev_var_in[loc_pp + {}] - dev_var_in[loc_pp + {}]) * {};\n",
            "calc_deriv42_z": "\toutput[pp] = (dev_var_in[loc_pp - {}] - 8.0 * dev_var_in[loc_pp - {}] + "
                                 "8.0 * dev_var_in[loc_pp + {}] - dev_var_in[loc_pp + {}]) * {};\n",
            ...
            "calc_deriv42_yy":  "\toutput[pp] = ((-1)*dev_var_in[loc_pp-{}] + 16.0*dev_var_in[loc_pp-{}] "
                               "- 30.0*dev_var_in[loc_pp] + 16.0*dev_var_in[loc_pp+{}] - dev_var_in[loc_pp+{}])*{};\n",
            "calc_deriv42_zz": "\toutput[pp] = ((-1)*dev_var_in[loc_pp-{}] + 16.0*dev_var_in[loc_pp-{}] "
                                 "- 30.0*dev_var_in[loc_pp] + 16.0*dev_var_in[loc_pp+{}] - dev_var_in[loc_pp+{}])*{};\n"
            }
...
advFirstPassParam = {
            ...
            "calc_deriv42_adv_y" : [tile_sz+6, tile_sz+6, 2*(tile_sz+6), 3*(tile_sz+6)],
            "calc_deriv42_adv_z" : [(tile_sz+6)*(tile_sz+6), (tile_sz+6)*(tile_sz+6),
                                    2*(tile_sz+6)*(tile_sz+6), 3*(tile_sz+6)*(tile_sz+6)]
            }

# adv else output
advSecondPassParam = {
            "calc_deriv42_adv_x" : [3, 2, 1, 1],
            "calc_deriv42_adv_y" : [3 * (tile_sz+6) , 2*(tile_sz+6), (tile_sz+6), (tile_sz+6)],
            "calc_deriv42_adv_z" : [3*(tile_sz+6)*(tile_sz+6), 2*(tile_sz+6)*(tile_sz+6),
                                   (tile_sz+6)*(tile_sz+6), (tile_sz+6)*(tile_sz+6)]
            }
# adv methods
