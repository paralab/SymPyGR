...
#You should install graphviz  and add the bin path to the environment path variable
...
def generate_dependencies(expression):
    global dot
    global nodes
    ...
    for arg in args:
        if(len(arg .args)==0):
            ...
            dot.edge(node_name, generate_dependencies(arg))
